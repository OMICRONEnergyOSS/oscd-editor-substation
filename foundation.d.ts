...
export declare function isEditRequest(wizard: unknown): wizard is EditWizardRequest;
export declare function isCreateRequest(wizard: unknown): wizard is CreateWizardRequest;
